...
| Tool | Purpose in Project | Monthly Cost | Annual Cost |
|---|---|---|---|
| GitHub | Repository + Kanban Project Board + Version Control | ₹0 | ₹0 |
| Google Sheets | Raw data storage + data cleaning | ₹0 | ₹0 |
| Google Looker Studio | Live interactive dashboard | ₹0 | ₹0 |
| DB Fiddle | SQL query writing + testing | ₹0 | ₹0 |
| Google Docs | Project documentation | ₹0 | ₹0 |
...
> Time is the only real investment in this project.
...
| Paid Tool | Free Alternative Used | Saving |
|---|---|---|
| Power BI Pro (₹750/month) | Google Looker Studio | ₹9,000/year |
| Tableau Public (limited) / Tableau Desktop (₹4,200/month) | Google Looker Studio | ₹50,400/year |
| Jira (₹700/user/month) | GitHub Projects Kanban | ₹8,400/year |
| AWS RDS for SQL | DB Fiddle (browser-based) | ₹2,000+/month |
...
| Tool | Purpose | Cost |
|---|---|---|
| BigQuery (Google Cloud) | Large-scale SQL on real datasets | ₹0 (10GB free tier) |
| Power BI Pro | Enterprise dashboard with row-level security | ₹750/user/month |
| Jira Software | Advanced sprint + backlog management | ₹700/user/month |
